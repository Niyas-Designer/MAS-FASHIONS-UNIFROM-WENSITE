...
const pageContexts = {
  ...
  '/about': 'MAS FASHIONZ (A Unit of Zeal Groups.) and your uniform manufacturing capabilities',
  ...
  '/clients': 'working with MAS FASHIONZ (A Unit of Zeal Groups.) as our long-term uniform partner',
  '/careers': 'career opportunities at MAS FASHIONZ (A Unit of Zeal Groups.)',
...
export function getWhatsAppUrl(pathname, source = 'website') {
  ...
  const careerMessage = pathname === '/careers'
    ? `Hello MAS FASHIONZ (A Unit of Zeal Groups.), I am interested in ${context}. Please share the current openings and application process.`
    : `Hello MAS FASHIONZ (A Unit of Zeal Groups.), I am interested in ${context}. Please help me with suitable options, minimum quantity, customization, pricing, and delivery timeline.`
