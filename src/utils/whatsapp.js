...
const pageContexts = {
  ...
  '/about': 'MAS FASHION and your uniform manufacturing capabilities',
  ...
  '/clients': 'working with MAS FASHION as our long-term uniform partner',
  '/careers': 'career opportunities at MAS FASHION',
...
export function getWhatsAppUrl(pathname, source = 'website') {
  ...
  const careerMessage = pathname === '/careers'
    ? `Hello MAS FASHION, I am interested in ${context}. Please share the current openings and application process.`
    : `Hello MAS FASHION, I am interested in ${context}. Please help me with suitable options, minimum quantity, customization, pricing, and delivery timeline.`
