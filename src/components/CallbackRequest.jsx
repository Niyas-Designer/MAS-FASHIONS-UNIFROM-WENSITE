...
const DEFAULT_FORM_ENDPOINT = 'https://formsubmit.co/manzoor@zealgroups.in'
const configuredEndpoint = import.meta.env.VITE_FORMSUBMIT_ENDPOINT?.trim()
const FORM_ENDPOINT = configuredEndpoint?.startsWith('https://formsubmit.co/') ? configuredEndpoint : DEFAULT_FORM_ENDPOINT
      ...
      >
        ...
        >
          ...
          {submitted ? <motion.div className="callback-success" initial={{opacity:0,y:18}} animate={{opacity:1,y:0}}>
            ...
            <p>Thank you for contacting MAS FASHIONS (A Unit of Zeal Groups.). A uniform consultant will review your requirements and get in touch during business hours.</p>
            ...
            <form className="callback-form" action={FORM_ENDPOINT} method="POST" encType="multipart/form-data" onSubmit={submit}>
              ...
              <p className="callback-privacy">By submitting, you agree that MAS FASHIONS (A Unit of Zeal Groups.) may contact you about this request.</p>
            </form>
          </>}
        </motion.aside>
      </motion.div>}
