...
export default function Collection() {
  ...
  return <motion.main className="inner-page" initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}}>
    <PageSEO title={`${displayTitle.charAt(0).toUpperCase()+displayTitle.slice(1)} | MAS FASHION`} description="Explore purpose-built corporate, school, healthcare, hospitality and industrial uniform collections manufactured and customized by MAS FASHION." />
    <section className="inner-hero collection-hero"><span className="eyebrow">MAS FASHION collections</span><h1>{displayTitle}<br/><em>for modern teams.</em></h1><p>Purposeful silhouettes, hardworking fabrics, and a standard of finish people notice—developed into coordinated programs rather than isolated pieces.</p></section>
