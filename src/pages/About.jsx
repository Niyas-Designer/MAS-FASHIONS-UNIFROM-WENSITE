...
export default function About() {
  return <motion.main className="inner-page" initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}}>
    <PageSEO title="About MAS FASHIONZ (A Unit of Zeal Groups.) | Uniform Manufacturer in Tiruppur" description="Learn about MAS FASHIONZ (A Unit of Zeal Groups.), a Tiruppur-based uniform manufacturer combining garment expertise, integrated production, quality control and customized service." />
    <section className="inner-hero about-hero"><span className="eyebrow">Who we are</span><h1>Professional manufacturing.<br/><em>Personalized solutions.</em></h1><p>MAS FASHIONZ (A Unit of Zeal Groups.) helps organizations turn practical uniform requirements into dependable, well-made apparel programs.</p></section>

    <section className="about-split container section-pad"><Reveal><span className="eyebrow">About MAS FASHIONZ (A Unit of Zeal Groups.)</span><h2>Uniform expertise built around quality, durability, and appearance.</h2></Reveal><Reveal delay={.12}><p>Based in Tiruppur, one of India’s most respected garment manufacturing centers, MAS FASHIONZ (A Unit of Zeal Groups.) develops customized uniforms for businesses, schools, factories, healthcare providers, hospitality teams and service organizations.</p><p>We connect design understanding with production reality. That means considering how a garment must move, how often it will be washed, how it represents the organization, and how reliably it can be reproduced across sizes and repeat orders.</p><p>Our purpose is straightforward: make uniform programs easier to manage and better to wear.</p></Reveal></section>

    <section className="about-editorial">
      <div className="about-editorial-image"><img src="/images/pages/about-team.jpg" alt="MAS FASHIONZ (A Unit of Zeal Groups.) design and production team reviewing a uniform" /></div>
    ...
    <section className="about-journey container section-pad">
      <Reveal className="inner-section-head"><span className="eyebrow">A dependable partner</span><h2>What working with<br/><em>MAS FASHIONZ (A Unit of Zeal Groups.) feels like.</em></h2></Reveal>
